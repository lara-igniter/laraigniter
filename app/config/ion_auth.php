...
$config['tables']['user_group']         = 'user_group';
$config['tables']['login_attempts']     = 'login_attempts';
$config['tables']['permissions']        = 'permissions';
$config['tables']['group_permission']   = 'group_permission';
...
$config['user_expire']                = 86400;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
