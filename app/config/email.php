...
$config['useragent']        = getenv('MAIL_USERAGENT','PHPMailer');              // Mail engine switcher: 'CodeIgniter' or 'PHPMailer'
$config['protocol']         = getenv('MAIL_DRIVER','smtp');                   // 'mail', 'sendmail', or 'smtp'
...
$config['smtp_port']        = getenv('MAIL_PORT','2525');
$config['smtp_timeout']     = 30;                       // (in seconds)
$config['smtp_crypto']      = getenv('MAIL_ENCRYPTION','');                       // '' or 'tls' or 'ssl'
